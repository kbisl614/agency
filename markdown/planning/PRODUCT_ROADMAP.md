...
Four agents. Deployed based on what the discovery call surfaces. Every client starts with the Responder.

| Agent | What it kills | When deployed |
|---|---|---|
| **The Responder** | Missed leads, slow response | Always first |
| **The Quoter** | Late-night quoting, low close rate | After Concierge is stable |
| **The Dispatcher** | Empty gaps, cancellation waste | After Concierge has 30+ days of data |
| **The Advisor** | Dead customer list, no visibility | After Concierge has 30+ days of data |
...
## Phase 2 — Complete the Responder (After First Client Signs)
...
## Phase 3 — The Quoter (Month 2, With First Client)
