...
Every new client goes through this playbook. Agents deployed depend on the discovery call scope — every client starts with the Concierge minimum. The 48-hour promise is the target; phone number porting may extend this to 5-7 days (see Step 5).
