...
/**
 * Jobber Contractor Landing Page
 *
 * Tailored for HVAC contractors already using Jobber for invoicing & dispatch.
 * Key message: "Jobber Handles Your Invoices. We Handle Everything Else."
 */

export const metadata = {
  title: "Automated Emergency Dispatch for Jobber | DispatchHVAC",
  description:
    "Fill emergency calls and cancellations automatically. We integrate directly with your Jobber account. 30-day free trial.",
  keywords: [
    "HVAC contractor",
    "Jobber integration",
    "emergency leads",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-8 animate-fade-in-down">
            <span className="text-sm font-semibold text-amber-400">
              For Jobber Contractors
            </span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-white mb-6 leading-tight animate-fade-in-up">
            Jobber Handles Your Invoices
            <br />
            <span className="gradient-text">We Handle Everything Else</span>
          </h1>

          <p className="text-xl lg:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-100">
            Direct integration with Jobber. We capture your emergency calls and fill cancellations automatically — your dispatch problem is solved while you focus on the work.
          </p>
          ...
          <p className="text-slate-400 text-sm mt-8 animate-fade-in-up delay-400">
            No credit card. $1,500/month. Works with Jobber accounts worldwide.
          </p>
        </div>
      </div>
    </section>
