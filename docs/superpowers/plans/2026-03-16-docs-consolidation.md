...
|---|---|---|---|
| 1 | FastAPI + Airtable + Twilio in old docs | `updated-files/agent-ops.md`, `PLAN_1_Updated.md` | n8n + Supabase + SignalWire |
...
| Path | Why Stale |
|---|---|
| `updated-files/agent-ops.md` | FastAPI + Airtable + Twilio — wrong stack entirely, $4,700 ROI |
| `updated-files/PLAN_1_Updated.md` | FastAPI, Airtable, Twilio, setup fee pricing, no Phase 2a/2b |
